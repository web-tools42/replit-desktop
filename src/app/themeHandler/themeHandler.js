...
class ThemeHandler {
    ...
    addTheme(parentWindow, code = 'default') {
        if (code == 'default') {
            if (this.settings.has('theme')) {
                code = this.settings.get('theme').code;
            }
            else
                return;
        }
