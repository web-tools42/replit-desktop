...
--dark-green: #485b4a;
--unupvoted: #3f403f;
--upvote: <% if (upvote == "") { %>rgba(255, 255, 255, 15%)<% } else { %>#<%= upvote %><% } %>;
--upvoted: <% if (upvote == "") { %>rgba(255, 255, 255, 90%)<% } else { %>#<%= upvote %><% } %>;
...
<% if (fallback == "") { %><% } else { %>color: #<%= fallback %>!important;<% } %>
}
<% if (grayscale == "true") { %>
body {
...
{
<% rainbow = false; pewdiepie=false;timchen=false;%>
<% if (rainbow == "true") { %>
animation: rainbowColor 5s infinite linear!important;
<% } else if (pewdiepie == "true") { %>
background-image:url(https://darktheme.matdoes.dev/pewdiepieSwirls.png?);
background-size: 100%;
background-color: var(--dark-bg)!important;
<% } else if (timchen == "true") { %>
background-image:url(https://timchen.mat1.repl.co/api/random.png?);
background-size: 100%;
background-color: var(--dark-bg)!important;
<% } else { %>
background-color: var(--dark-bg)!important;
...
{
<% if (rainbow == "true") { %>
animation: rainbowColor 4s infinite linear!important;
<% } else { %>
